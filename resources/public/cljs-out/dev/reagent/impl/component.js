...
if((i < len)){
var k = (ks[i]);
var G__14658 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__14659 = (i + (1));
m = G__14658;
i = G__14659;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__14661 = c;
var G__14661__$1 = (((G__14661 == null))?null:G__14661.prototype);
if((G__14661__$1 == null)){
return null;
} else {
return (G__14661__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__14663 = c;
var G__14663__$1 = (((G__14663 == null))?null:G__14663.prototype);
if((G__14663__$1 == null)){
return null;
} else {
return (G__14663__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__14666__delegate = function (args){
...
while (G__14667__i < G__14667__a.length) {G__14667__a[G__14667__i] = arguments[G__14667__i + 0]; ++G__14667__i;}
  args = new cljs.core.IndexedSeq(G__14667__a,0,null);
} 
...
var args = cljs.core.seq(arglist__14668);
...
var _STAR_current_component_STAR_14670 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14670;
}});
...
return ((function (G__14671,G__14671__$1){
...
var c = this;
var G__14676_14678 = (c["cljsRatom"]);
if((G__14676_14678 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__14676_14678);
}
...
var renders_14680 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_14681 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_14680));
if((cljs.core.count.call(null,renders_14680) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_14680))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_14681)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_14681))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__14679 = name;
switch (G__14679) {
case "":
...
var G__14683 = o;
(G__14683[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__14684 = fiber;
var G__14684__$1 = (((G__14684 == null))?null:(G__14684["type"]));
if((G__14684__$1 == null)){
return null;
} else {
return (G__14684__$1["displayName"]);
}
})();
var parent = (function (){var G__14685 = fiber;
if((G__14685 == null)){
return null;
} else {
return (G__14685["return"]);
}
})();
var path = (function (){var G__14686 = parent;
var G__14686__$1 = (((G__14686 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__14686));
if((G__14686__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14686__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__14688 = c;
if((G__14688 == null)){
return null;
} else {
return (G__14688["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__14689._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__14691 = c;
if((G__14691 == null)){
return null;
} else {
return (G__14691["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__14693 = c;
if((G__14693 == null)){
return null;
} else {
return G__14693._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__14695 = instance;
if((G__14695 == null)){
return null;
} else {
return (G__14695["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__14696 = instance;
if((G__14696 == null)){
return null;
} else {
return G__14696._currentElement;
}
}
})();
var name = (function (){var G__14697 = elem;
var G__14697__$1 = (((G__14697 == null))?null:(G__14697["type"]));
if((G__14697__$1 == null)){
return null;
} else {
return (G__14697__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__14699 = elem;
if((G__14699 == null)){
return null;
} else {
return (G__14699["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__14700._owner;
}
}
})();
var path = (function (){var G__14701 = owner;
var G__14701__$1 = (((G__14701 == null))?null:reagent.impl.component.component_path.call(null,G__14701));
if((G__14701__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14701__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__14702 = c;
var G__14702__$1 = (((G__14702 == null))?null:G__14702.constructor);
if((G__14702__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__14702__$1);
}
}
})();
