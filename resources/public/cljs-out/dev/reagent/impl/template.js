...
var G__14715 = o;
(G__14715[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__14717__i < G__14717__a.length) {G__14717__a[G__14717__i] = arguments[G__14717__i + 0]; ++G__14717__i;}
  args = new cljs.core.IndexedSeq(G__14717__a,0,null);
} 
...
var G__14719 = o;
(G__14719[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__14720__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__14720__delegate.call(this,args);};
...
return G__14720__delegate(args);
});
...
var G__14724 = props;
var G__14724__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__14724,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14724);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14724__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__14725){
var map__14726 = p__14725;
var map__14726__$1 = ((((!((map__14726 == null)))?(((((map__14726.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14726.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14726):map__14726);
var props = map__14726__$1;
var class$ = cljs.core.get.call(null,map__14726__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__14726,map__14726__$1,props,class$){
return (function (c){
...
});})(map__14726,map__14726__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14728){
...
var on_write = cljs.core.get.call(null,map__14729__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__14729,map__14729__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__14729,map__14729__$1,on_write))
);
} else {
...
var G__14732 = jsprops;
(G__14732["defaultValue"] = value);

(G__14732["onChange"] = ((function (G__14732,v,value,on_change){
return (function (p1__14731_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14731_SHARP_);
});})(G__14732,v,value,on_change))
);
...
var vec__14735 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14735,(0),null);
var id = cljs.core.nth.call(null,vec__14735,(1),null);
var class$ = cljs.core.nth.call(null,vec__14735,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___14739 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___14739 == null)){
} else {
var key_14740 = temp__5461__auto___14739;
(jsprops["key"] = key_14740);
}
...
var temp__5461__auto___14741 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___14741 == null)){
} else {
var key_14742 = temp__5461__auto___14741;
reagent.impl.template.oset.call(null,jsprops,"key",key_14742);
}
...
var G__14743 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__14743["name"] = c);
...
var len__4531__auto___14748 = arguments.length;
var i__4532__auto___14749 = (0);
while(true){
if((i__4532__auto___14749 < len__4531__auto___14748)){
args__4534__auto__.push((arguments[i__4532__auto___14749]));

var G__14750 = (i__4532__auto___14749 + (1));
i__4532__auto___14749 = G__14750;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14746){
var G__14747 = cljs.core.first.call(null,seq14746);
var seq14746__$1 = cljs.core.next.call(null,seq14746);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14747,seq14746__$1);
});
...
break;
default:
var G__14753 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__14753;
continue;
...
var n__4408__auto___14755 = a.length;
var i_14756 = (0);
while(true){
if((i_14756 < n__4408__auto___14755)){
(a[i_14756] = reagent.impl.template.as_element.call(null,(a[i_14756])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___14758 = a.length;
var i_14759 = (0);
while(true){
if((i_14759 < n__4408__auto___14758)){
var val_14760 = (a[i_14759]);
if(((cljs.core.vector_QMARK_.call(null,val_14760)) && ((reagent.impl.template.key_from_vec.call(null,val_14760) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_14759] = reagent.impl.template.as_element.call(null,val_14760));
...
var ctx = ({});
var vec__14762 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__14762,(0),null);
var derefed = cljs.core.nth.call(null,vec__14762,(1),null);
...
var G__14765 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14765) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__14765){
