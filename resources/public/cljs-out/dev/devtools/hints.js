...
}catch (e17197){var _e = e17197;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___17200 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___17200)){
var seen_errors_17201 = temp__5455__auto___17200;
if(cljs.core.truth_(seen_errors_17201.has(self))){
} else {
seen_errors_17201.add(self);

var temp__5457__auto___17202 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___17202)){
var sense_17203 = temp__5457__auto___17202;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_17203)].join('');
} else {
}
}
} else {
