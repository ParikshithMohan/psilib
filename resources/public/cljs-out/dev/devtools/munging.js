...
var o16079 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16079["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16080 = temp__5455__auto____$1;
return (o16080["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15191__auto__ = f;
return (o__15191__auto__["toString"]).call(o__15191__auto__);
} else {
return "";
}
}catch (e16081){var _ = e16081;
return "";
}});
...
try{var o__15191__auto___16083 = t;
(o__15191__auto___16083["cljs$lang$ctorPrWriter"]).call(o__15191__auto___16083,t,writer);
}catch (e16082){var __16084 = e16082;
}
...
var char_code = (function (){var o__15191__auto__ = (new String(char$));
return (o__15191__auto__["charCodeAt"]).call(o__15191__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15191__auto__ = String;
return (o__15191__auto__["fromCharCode"]).call(o__15191__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16085 = num_code;
switch (G__16085) {
case (1):
return (185);
...
var o__15191__auto__ = String;
return (o__15191__auto__["fromCharCode"]).call(o__15191__auto__,superscript_code);
});
/**
...
}catch (e16087){var _e__15198__auto__ = e16087;
return false;
}})())){
...
var vec__16088 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16088,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o16091 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16091["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16092 = temp__5455__auto____$1;
return (o16092["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16095){
var vec__16096 = p__16095;
var ns_detector = cljs.core.nth.call(null,vec__16096,(0),null);
...
var G__16102 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16103 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16102;
remaining_tokens = G__16103;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16093){
var G__16094 = cljs.core.first.call(null,seq16093);
var seq16093__$1 = cljs.core.next.call(null,seq16093);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16094,seq16093__$1);
});
...
var vec__16107 = cljs.core.split_with.call(null,(function (p1__16106_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16106_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16107,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16107,(1),null);
...
var vec__16110 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16110,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16110,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16113 = cljs.core.rest.call(null,remaining_tokens);
var G__16114 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16113;
name_tokens = G__16114;
continue;
} else {
...
var vec__16117 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16117,(0),null);
var arity = cljs.core.nth.call(null,vec__16117,(1),null);
var vec__16120 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16120,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16120,(1),null);
var vec__16123 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16123,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16123,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16123,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16123,(3),null);
...
var vec__16129 = result;
var munged_ns = cljs.core.nth.call(null,vec__16129,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16129,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16129,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16129,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16129,(4),null);
var arity = cljs.core.nth.call(null,vec__16129,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__16133 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__16133,(0),null);
var args = cljs.core.nth.call(null,vec__16133,(1),null);
var vec__16136 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16136,(0),null);
var name = cljs.core.nth.call(null,vec__16136,(1),null);
...
var G__16139 = (arity + (1));
var G__16140 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16141){
var vec__16142 = p__16141;
var arity = cljs.core.nth.call(null,vec__16142,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16142,(1),null);
...
return cljs.core.get.call(null,arities,p1__16145_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16146_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16149){
var vec__16150 = p__16149;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16150,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16147){
var G__16148 = cljs.core.first.call(null,seq16147);
var seq16147__$1 = cljs.core.next.call(null,seq16147);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16148,seq16147__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16158__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16158__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16158__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16158__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16159 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16159,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16159,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16159,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16159,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16159,(4),null);
var arity = cljs.core.nth.call(null,vec__16159,(5),null);
...
var o__15191__auto__ = f;
return (o__15191__auto__["getBasis"]).call(o__15191__auto__);
});
/**
...
}catch (e16163){var _e__15198__auto__ = e16163;
...
var G__16164 = (obj[cljs.core.first.call(null,path)]);
var G__16165 = cljs.core.rest.call(null,path);
obj = G__16164;
path = G__16165;
continue;
} else {
...
return (function (accum,p__16166){
var vec__16167 = p__16166;
var bit = cljs.core.nth.call(null,vec__16167,(0),null);
var protocol = cljs.core.nth.call(null,vec__16167,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16170){
var vec__16171 = p__16170;
var ns = cljs.core.nth.call(null,vec__16171,(0),null);
var name = cljs.core.nth.call(null,vec__16171,(1),null);
var selector = cljs.core.nth.call(null,vec__16171,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16176,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16176,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16176,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16174_SHARP_){
return (obj[cljs.core.first.call(null,p1__16174_SHARP_)]);
});})(name,sorted_matches,vec__16176,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
