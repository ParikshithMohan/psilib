...
var G__16181 = devtools.prefs.pref.call(null,v);
v = G__16181;
continue;
} else {
return v;
...
}catch (e16184){var _e__15198__auto__ = e16184;
return false;
}})();
...
}catch (e16188){var _e__15198__auto__ = e16188;
return false;
}})();
...
}catch (e16190){var _e__15198__auto__ = e16190;
return false;
}}
}
});
...
var vec__16192 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16192,(0),null);
var name = cljs.core.nth.call(null,vec__16192,(1),null);
...
return cljs.core.some.call(null,(function (p1__16195_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16195_SHARP_);
}),template);
});
